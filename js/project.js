const projects = [
    ...
    {
        id: "toxic",
        image: "/assets/images/Main-Toxic.svg",
        title: "Toxic Comment Classification",
        byline: "Classify toxic comments using NLP",
        heading1: "About",
        ...
        heading2: "Source Code",
        content2: "You may head on to <a href='https://github.com/YashvardhanG/Toxic-Comment-Classification'>Toxic Comment Classification</a> to explore and know more about the project."
    },

    {
        id: "fall",
        image: "/assets/images/Main-Fall.svg",
        title: "Fall Detection for Parkinson Disease",
        byline: "An IOT based assistive device for Parkinson's patients", 
        heading1: "About",
        content1: "In this research, we focus on the task of toxic comment classification using tone analysis. Our goal is to develop a machine learning-based model that can accurately classify toxic comments and distinguish them from non-toxic comments. Specifically, we will explore various approaches to feature extraction, model selection, and optimization to achieve high accuracy and robustness in our classification model. We will also discuss the ethical considerations and limitations of using NLP for toxic comment classification, such as the risk of algorithmic bias and the challenges of defining what constitutes toxic language.<br><br>Overall, our research aims to contribute to the development of effective tools for detecting and combating toxic online behavior, with the ultimate goal of creating a safer and more inclusive online community. We believe that our work can make a significant impact on the field of NLP and contribute to the ongoing efforts to address the challenges of toxic online behavior.<br><br>The results of the project demonstrate the potential of NLP techniques for identifying and classifying toxic comments in various contexts. While the models developed achieved reasonable levels of accuracy, there is still room for improvement, particularly in terms of incorporating additional features and training on larger datasets.",
        heading2: "Output",
...

    {
        ...
        heading1: "About",
        content1: "Parkinson's disease is a brain condition that results in unintentional or uncontrolled movements including trembling, stiffness, and issues with balance and coordination. To allow early detection, differential diagnosis, and objective measurement of symptoms across time, a Parkinson's disease IoT-based device is required. This project focuses on wearable sensors which can offer patients and carers real-time input to assist in the treatment of the condition. Additionally, Parkinson's disease patients can receive individualised and customised treatments and therapies through IoT-based devices, which can enhance their quality of life. <br><br>This IoT-based assistive device for Parkinson's disease will consist of sensors such as accelerometers, gyroscopes, and short-range communication technologies such as Bluetooth and WiFi communication. Additionally, AI-based systems are deployed to develop sophisticated assistive technologies. These sensors will help to track the motion of a patient, detect if they are falling, and also notify the emergency contact with the location information using the GSM module.",
        heading2: "Functionality",
...

    {
        ...
        byline: "UEBA using LSTM Models",
        heading1: "About",
        content1: "Using deep learning techniques, this research provides a unique way for detecting abnormal behaviours of both humans and entities in computer systems. To learn the patterns of typical behaviours and detect anomalies, the suggested approach employs a combination of long short-term memory (LSTM)-based autoencoders. The approach takes use of the temporal character of user and entity behaviours by modelling temporal interdependence between actions and between action sequences using LSTM networks. Autoencoders are used to detect deviations from the expected baseline behaviour. The proposed approach detects abnormal behaviours of both users and entities, according to experimental results on the real-world CERT dataset. The method is evaluated using Weighted Distance Deviation (WDD) values for a user's daily actions compared to the standard action features over time. The WDD values are used to measure the deviation between a user's daily behavior and the standard behavior for their role, thus detecting anomalies as and when they occur. Overall, this study proposes a potential method for detecting abnormal behaviours of both individuals and entities in computer systems, which might be applied to a variety of applications such as cybersecurity within organizations and fraud detection.<br><br>The objective of a project on User and Entity Behavior Analytics (UEBA) using Deep Learning in the context of Information Security Management is to leverage artificial intelligence and machine learning techniques to detect and mitigate security threats within an organization. The project aims to achieve the following objectives:<br><br>1. Automate the process of detecting abnormal user and entity behavior patterns that may indicate security threats<br>2. Enhance the accuracy and efficiency of security threat detection by incorporating deep learning algorithms<br>3. Provide real-time monitoring and alerting for potential security incidents<br>4. Improve the speed of incident response and investigation through better data collection and analysis<br>5. Reduce the workload on security teams by automating the detection and investigation process<br>6. Provide actionable intelligence to security teams to help prioritize remediation efforts and improve overall security posture.",
        heading2: "Source Code and Results",
        content2: "The source code for this project and all it's resources are available at: <a href = 'https://colab.research.google.com/drive/1PcRgQIlQRhaftxUTpAl6lZPelwLHFxpj'>Source Code</a>."
    },

    {
        id: "jude",
        image: "/assets/images/Main-Jude.svg",
        title: "J.U.D.E",
        byline: "AI Based Assistant | J.U.D.E - Just a User-friendly Dialogue Entity",
        heading1: "About",
        content1: "This project aims to develop a voice-based virtual assistant using Python programming language, along with AI and NLP techniques, to perform various tasks based on voice commands and queries. The proposed work is important as it enables users to interact with their devices in a more natural and intuitive way, without the need for manual input. It also provides an efficient and personalized user experience by understanding natural language and responding accordingly. The virtual assistant developed in this project can perform a range of tasks including setting reminders based on the conversations users have on a daily, opening websites and applications, helping with translations, dictionary, and other language-related tasks, and assisting with all basic functionalities of a laptop. By understanding and processing natural language, the virtual assistant is able to interpret user input and perform the necessary tasks. The project results indicate that the virtual assistant can set reminders on the basis of daily conversations efficiently and accurately, thereby providing an improved user experience compared to existing methods. The performance and effectiveness of the system are compared with existing voice-based virtual assistants with regards to this task to evaluate its efficacy. The project thus provides a useful contribution towards the development of voice-based virtual assistants that can assist users with daily tasks in a more natural and intuitive manner.<br><br>The proposed work involves developing a voice-based virtual assistant using Python programming language with AI and NLP techniques. The virtual assistant aims to perform various tasks based on voice commands and queries, including setting reminders, opening websites and applications, providing language-related assistance, and performing all basic functionalities of a laptop. To achieve this, the project involves integrating several AI and NLP techniques, such as speech recognition, sentiment analysis, and text-to-speech conversion, to enable the virtual assistant to understand and respond to user input accurately and efficiently. The system will also be designed to personalize the user experience by learning from previous interactions and adapting to individual preferences. The effectiveness and performance of the system will be evaluated by comparing it with existing voice-based virtual assistants with regards to the task of setting reminders based on daily conversations. The project aims to contribute towards the development of more natural and intuitive voice-based virtual assistants that can assist users with daily tasks efficiently and effectively",
        heading2: "Results",
        content2: "In conclusion, this project successfully implemented an AI-based virtual assistant that can perform a variety of tasks, including event detection, reminders, and answering undefined questions using NLP models such as Microsoft-Dialo-GPT. The project demonstrated that AI can be leveraged to automate routine tasks and make them easier for users, ultimately enhancing productivity and efficiency.<br><br>One of the biggest advantages of the AI-powered virtual assistant developed in this project is its reminder functionality. The assistant uses natural language processing models to detect event information from user inputs and sets reminders accordingly. This feature can greatly benefit users in managing their schedules and ensuring that important tasks are not forgotten.",
        heading3: "Source Code",
        content3: "The source code for this project and all it's resources are available at: <a href = 'https://github.com/shrikarjayaraman/J.U.D.E'>Source Code</a>."
    },
